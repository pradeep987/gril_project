											...
											<div class="tab-pane" id="tab2"
												...
												<form class="form-horizontal" enctype="multipart/form-data"
													...
													<div class="form-group"
														...
														<div class="col-md-4">
															<input type="text" class="form-control" focus-element
																name="postalCode" ng-model="bussReg.save.postalCode"
																ng-minlength="1" ng-maxlength="10" required
																ng-blur="codeAddress()" /> <span
													...
													<div class="form-group"
														...
														<div class="col-md-4">
															<input type="text" class="form-control" focus-element
																name="city" ng-model="bussReg.save.city"
																ng-minlength="3" ng-maxlength="64" required /> <span
													...
													<div class="form-group"
														...
														<div class="col-md-4">
															<input type="text" class="form-control" focus-element
																name="county" ng-model="bussReg.save.county"
																ng-minlength="3" ng-maxlength="64" required /> <span
												...
												<form class="form-horizontal" name="regClassform" action="#"
													...
													<div class="form-group"
														...
														<label class="control-label col-md-3">Description <span
															class="required"> * </span> </label>
														<div class="col-md-4">
															<textarea type="text" class="form-control" focus-element
