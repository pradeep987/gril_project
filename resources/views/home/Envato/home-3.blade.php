...
<!-- Mirrored from codechant.com/Envato/html/rosa/home-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Apr 2017 09:35:40 GMT -->
<head>
    <!-- Metas -->
    <meta charset="UTF-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="module shop-widget offer-widget">
                        <h4 class="module-title linked-title"><a href="#"><i class="fa fa-arrows" aria-hidden="true"></i>Specials of the week</a><span class="toggle-btn"></span></h4>
                        <div class="module-content mobile-collapse">
                            <div class="carousel-item-4 owl-carousel">
                                <div class="product">
                    ...
                    <div class="module shop-widget top-widget secondary-module">
                        ...
                        <div class="module-content mobile-collapse">
                            <ul class="widget-products">
                                ...
                                <li class="widget-product">
                                    <a class="widget-item-img" href="#">
                                        <img "<?= asset('Envato/img/product/sthumb-2.jpg') ?>" alt="Product Thumb">
                                    </a>
                                    <div class="widget-product-content">
                                        <h5 class="product-name"><a href="#">Lynn Skinny</a></h5>
                                        <div class="rating" itemtype="http://schema.org/Offer" itemscope>
