...
<!-- Mirrored from codechant.com/Envato/html/rosa/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Apr 2017 09:35:23 GMT -->
<head>
    <!-- Metas -->
    <meta charset="UTF-8">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="banner">
                        <a class="banner-box" href="#">
                            <img src="<?= asset('Envato/img/banner/img-static3.jpg') ?>" alt="banner box">
                        </a>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="banner">
                        <a class="banner-box" href="#">
                            <img src="img/banner/img-static4.jpg') ?>" alt="banner box">
                        </a>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="banner">
                        <a class="banner-box" href="#">
                            <img src="<?= asset('Envato/img/banner/img-static5.jpg') ?>" alt="banner box">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-4">
                    ...
                    <div class="module shop-widget offer-widget">
                        <h4 class="module-title linked-title"><a href="#"><i class="fa fa-arrows" aria-hidden="true"></i>Specials</a><span class="toggle-btn"></span></h4>
            ...
            <div class="module shop-widget banners">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="banner">
                            <a href="#">
                                <img src="<?= asset('Envato/img/banner/img-static4.jpg') ?>" alt="Banner">
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="banner">
                            <a href="#">
                                <img src="<?= asset('Envato/img/banner/img-static3.jpg') ?>" alt="Banner">
                            </a>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from codechant.com/Envato/html/rosa/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Apr 2017 09:35:40 GMT -->
</html>