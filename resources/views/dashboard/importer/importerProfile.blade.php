									...
									<div class="form-body">
										...
										<form class="form-horizontal" name="userClassform1" action="#"
											...
											<input type="hidden" name="id"
												ng-init="importerBuss[0].id = '{{Crypt::encrypt($data[0]->id)}}'" />
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussReg"
													ng-init="importerBuss[0].title = '{{!empty($data[0]) ? $data[0]->title : ''}}'"
											...
											<div class="form-group"
												...
												<label class="col-md-4">Classification<span class="required">
														* </span> </label>
												<div class="col-md-8" ng-show="!myBussReg"
													ng-init="importerBuss[0].clasification = '{{!empty($data[0]) ? $data[0]->clasification : ''}}'"
											...
											<div class="form-group"
												...
												<label class="col-md-4 left">Description <span
													class="required"> * </span> </label>
												<div class="col-md-8" ng-show="!myBussReg"
													ng-init="importerBuss[0].description = '{{!empty($data[0]) ? $data[0]->description : ''}}'"
									...
									<div class="form-body">
										<form class="form-horizontal" name="userClassform2" action="#"
											...
											<meta name="myBussProfile-csrf-token"
												content="{{ csrf_token() }}">
											<input type="hidden" name="id"
												ng-init="importerContactDtl[0].id = '{{Crypt::encrypt($data[0]->id)}}'" />
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].mobile = '{{!empty($data[0]) ? $data[0]->mobile : ''}}'"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].landline = '{{!empty($data[0]) ? $data[0]->landline : ''}}'"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].email = '{{!empty($data[0]) ? $data[0]->email : ''}}'"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].website = '{{!empty($data[0]) ? $data[0]->website : ''}}'"
											...
											<div class="form-group"
												...
												<label class="col-md-4">Business Name<span class="required">
														* </span> </label>
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].bussName = '{{!empty($data[0]) ? $data[0]->name : ''}}'"
											...
											<div class="form-group"
												...
												<label class="col-md-4 left">Number/Name<span
													class="required"> * </span> </label>
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].numberName = '{{!empty($data[0]) ? $data[0]->number_or_name : ''}}'"
											...
											<div class="form-group"
												...
												<label class="col-md-4 left">Address 1<span class="required">
														* </span> </label>
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].address_1 = '{{!empty($data[0]) ? $data[0]->address_1 : ''}}'"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].address_2 = '{{!empty($data[0]) ? $data[0]->address_2 : ''}}'"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].postal_code = '{{!empty($data[0]) ? $data[0]->postal_code : ''}}'"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].city = '{{!empty($data[0]) ? $data[0]->city : ''}}'"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="importerContactDtl[0].county = '{{!empty($data[0]) ? $data[0]->county : ''}}'"
