...
-->
                                                   ...
                                                   <div class="portlet-body">
                                                      <div class="row">
                                                       ...
                                                       <div class="col-md-4"  ng-class="productInformation.provideProductName.$dirty ? (productInformation.provideProductName.$valid ? 'has-success' : 'has-error') : ''">
                                                                <input type="text" class="form-control" name="provideProductName" ng-model="customer.save.provideProductName"  ng-minlength="2" ng-maxlength="128"  required/>
															    ...
															    <span ng-show="productInformation.provideProductName.$error.minlength" class="help-block">Name have minimum 2 characters</span>
																<span ng-show="productInformation.provideProductName.$error.maxlength" class="help-block">Name have maximum 128 characters</span>
                                                            </div>
                                                    ...
                                                    <div class="form-group" ng-hide="provideNameCheck">
                                                       ...
                                                       <div class="col-md-4" ng-class="productInformation.ProductOfferPrice.$dirty ? (productInformation.ProductOfferPrice.$valid ? 'has-success' : 'has-error') : ''">
                                                                <input type="text" class="form-control" name="ProductOfferPrice" ng-model="customer.save.ProductOfferPrice"  ng-minlength="2" ng-maxlength="128"  required/>
																<span ng-show="productInformation.ProductOfferPrice.$error.required || productInformation.ProductOfferPrice.$valid" class="help-block">  Product Offer Price Details </span>
																<span ng-show="productInformation.ProductOfferPrice.$error.minlength" class="help-block">Product Offer Price Details should be minimum 2 characters</span>
																<span ng-show="productInformation.ProductOfferPrice.$error.maxlength" class="help-block">Product Offer Price Details should be maximum 128 characters</span>
                                                            </div>
                                                          </div>
                                                    <div class="form-group" ng-hide="provideNameCheck">
                                                       ...
                                                       <div class="col-md-4" ng-class="productInformation.ProductOfferInPercentage.$dirty ? (productInformation.ProductOfferInPercentage.$valid ? 'has-success' : 'has-error') : ''">
                                                                <input type="text" class="form-control" name="ProductOfferInPercentage" ng-model="customer.save.ProductOfferInPercentage"  ng-minlength="2" ng-maxlength="128"  required/>
																<span ng-show="productInformation.ProductOfferInPercentage.$error.required || productInformation.ProductOfferInPercentage.$valid" class="help-block">  Product Offer In Percentage Details </span>
																<span ng-show="productInformation.ProductOfferInPercentage.$error.minlength" class="help-block">Product Offer In Percentage Details should be minimum 2 characters</span>
																<span ng-show="productInformation.ProductOfferInPercentage.$error.maxlength" class="help-block">Product Offer In Percentage Details should be maximum 128 characters</span>
                                                            </div>
                                                          </div>
                                                ...
                                                <div class="mt-radio-inline" ng-init="limitedUnlimited = limited">
                                                    ...
                                                    <label class="mt-radio">
                                                        ...
                                                        <div class="col-md-4" ng-class="productInformation.ProductOfferValidFrom.$dirty ? (productInformation.ProductOfferValidFrom.$valid ? 'has-success' : 'has-error') : ''">
                                                                <input type="text" class="form-control" name="ProductOfferValidFrom" ng-model="customer.save.ProductOfferValidFrom"  ng-minlength="2" ng-maxlength="128"  required/>
																<span ng-show="productInformation.ProductOfferValidFrom.$error.required || productInformation.ProductOfferValidFrom.$valid" class="help-block"> Product Offer Valid From Details </span>
																<span ng-show="productInformation.ProductOfferValidFrom.$error.minlength" class="help-block"> Product Offer Valid From Details should be minimum 2 characters</span>
																<span ng-show="productInformation.ProductOfferValidFrom.$error.maxlength" class="help-block"> Product Offer Valid From Details should be maximum 128 characters</span>
                                                            </div>
                                                          </div>
                                                       ...
                                                       <div class="col-md-4" ng-class="productInformation.ProductOfferValidTo.$dirty ? (productInformation.ProductOfferValidTo.$valid ? 'has-success' : 'has-error') : ''">
                                                                <input type="text" class="form-control" name="ProductOfferValidTo" ng-model="customer.save.ProductOfferValidTo"  ng-minlength="2" ng-maxlength="128"  required/>
																...
																<span ng-show="productInformation.ProductOfferValidTo.$error.minlength" class="help-block">Product Offer Valid To Details should be minimum 2 characters</span>
																<span ng-show="productInformation.ProductOfferValidTo.$error.maxlength" class="help-block">Product Offer Valid To Details should be maximum 128 characters</span>
                                                            </div>
                                                          </div>  
                                                           <div class="form-group" ng-class="">      
                                                       ...
                                                       <div class="col-md-4" ng-class="productInformation.ProductPackageQuantityDetails.$dirty ? (productInformation.ProductPackageQuantityDetails.$valid ? 'has-success' : 'has-error') : ' ' ">
                                                                <input type="text" class="form-control" name="ProductPackageQuantityDetails" ng-model="customer.save.ProductPackageQuantityDetails"  ng-minlength="2" ng-maxlength="128"  required/ >
                                                 ...
                                                 <div class="portlet-title">
                                                   ...
                                                   <div class="portlet-body">
                                                      <div class="row" data-selectsplitter-wrapper-selector="">
                                                       ...
                                                       <div class="col-md-4" ng-class="productInformation.StockInHand.$dirty ? (productInformation.StockInHand.$valid ? 'has-success' : 'has-error') : ' ' ">
                                                            <input type="text" class="form-control" name="StockInHand" ng-model="customer.save.StockInHand"  ng-minlength="2" ng-maxlength="128"  required/>
                                                   ...
                                                   <div class="portlet-body">
                                                      <div class="row" data-selectsplitter-wrapper-selector="">
                                                       ...
                                                       <div class="col-md-4" ng-class="productInformation.ServiceCharges.$dirty ? (productInformation.ServiceCharges.$valid ? 'has-success' : 'has-error') : ' ' ">
                                                             <input type="text" class="form-control" name="ServiceCharges" ng-model="customer.save.ServiceCharges"  ng-minlength="2" ng-maxlength="128"  required/>
                                                   ...
                                                   <div class="portlet-body">
                                                      <div class="row" data-selectsplitter-wrapper-selector="">
                                                       ...
                                                       <div class="col-md-4" ng-class="productInformation.ProductWeight.$dirty ? (productInformation.ProductWeight.$valid ? 'has-success' : 'has-error') : ' ' ">
                                                             <input type="text" class="form-control" name="ProductWeight" ng-model="customer.save.ProductWeight"  ng-minlength="2" ng-maxlength="128"  required/>
                                                   ...
                                                   <div class="portlet-body">
                                                      ...
                                                      <div class="col-md-4" ng-class="productInformation.localdelivarycharges.$dirty ? (productInformation.localdelivarycharges.$valid ? 'has-success' : 'has-error') : ' ' ">
                                                             <input type="text" class="form-control" name="localdelivarycharges" ng-model="customer.save.localdelivarycharges"  ng-minlength="2" ng-maxlength="128"  required/>
                                                    ...
                                                    <div class="portlet-body">
                                                      <div class="row" data-selectsplitter-wrapper-selector="">
                                                       ...
                                                       <div class="col-md-4" ng-class="productInformation.OtherPlacesDeliveryCharges.$dirty ? (productInformation.OtherPlacesDeliveryCharges.$valid ? 'has-success' : 'has-error') : ' ' ">
                                                             <input type="text" class="form-control" name="OtherPlacesDeliveryCharges" ng-model="customer.save.OtherPlacesDeliveryCharges"  ng-minlength="2" ng-maxlength="128"  required/>
