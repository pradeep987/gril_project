...
<!-- BEGIN CONTAINER -->
<div
	class="page-container" ng-controller="businessTypeCtrl">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="m-heading-1 border-green m-bordered">
						<h3>Retail Business Type</h3>
						<p>Business Type master Page</p>
					</div>
					<div class="portlet light bordered" id="form_wizard_1">
						<div class="portlet-body form">
							<form class="businessTypeForm" name="businessTypeForm"
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<p>
																Are you sure want to delete this Business Type <span
																	id="businessTypeName"></span>?
															</p>
														...
														<div class="modal-body">
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessTypeForm.bcId.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<select id="county" class="form-control" name="bcId"
																			...
																			ng-options="obj.id as obj.name for obj in businessCategoryList">
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessTypeForm.businessType.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-4">Business Type <span
																		class="required"> * </span> </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control"
																			name="businessType" ng-model="saveItem.businessType"
																			ng-minlength="2" ng-maxlength="128" required /> <span
																			ng-show="businessTypeForm.businessType.$error.required || businessTypeForm.businessType.$valid"
																			class="help-block"> Enter the Business Type </span> <span
																			ng-show="businessTypeForm.businessType.$error.minlength"
																			class="help-block"> Business Type have minimum 2
																			characters</span> <span
																			ng-show="businessTypeForm.businessType.$error.maxlength"
																			class="help-block"> Business Type have maximum 128
																			characters</span>
																	</div>
																</div>
															</div>
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessTypeForm.seoTitle.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-4">SEO Title </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control"
																			name="seoTitle" ng-model="saveItem.seoTitle"
																			ng-maxlength="256" /> <span
																			ng-show="businessTypeForm.seoTitle.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessTypeForm.seoUrl.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="seoUrl"
																			...
																			ng-show="businessTypeForm.seoUrl.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessTypeForm.seoKeywords.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-4">SEO Key Words </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control"
																			name="seoKeywords" ng-model="saveItem.seoKeywords"
																			ng-maxlength="256" /> <span
																			ng-show="businessTypeForm.seoKeywords.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessTypeForm.seoTags.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="seoTags"
																			...
																			ng-show="businessTypeForm.seoTags.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessTypeForm.seoDesc.$valid ? 'has-success' : 'has-error'">
															...
															<div class="row margin-bottom15">
																<div class="form-group">
																	...
																	<div class="col-md-4">
																		<button type="button" ng-click="saveBusinessType()"
																			ng-disabled="!(!businessTypeForm.$error.required && !businessTypeForm.$error.maxlength && !businessTypeForm.$error.minlength)"
...
<script
	src="<?= asset('app/controllers/admin/businessType.js') ?>"></script>
</body>
