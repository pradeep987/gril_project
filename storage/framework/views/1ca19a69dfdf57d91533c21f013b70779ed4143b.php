...
<!-- BEGIN CONTAINER -->
<div
	class="page-container" ng-controller="countryCtrl">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="m-heading-1 border-green m-bordered">
						<h3>Country</h3>
						<p>Country master Page</p>
					</div>
					<div class="portlet light bordered" id="form_wizard_1">
						<div class="portlet-body form">
							<form class="countryForm" name="countryForm" id="submit_form"
								method="POST">
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<p>
																Are you sure want to delete this country <span
																	id="countryName"></span>?
															</p>
														...
														<div class="modal-body">
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countryForm.country.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-3">Country <span
																		class="required"> * </span> </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="country"
																			ng-model="saveItem.country" ng-minlength="2"
																			ng-maxlength="128" required /> <span
																			ng-show="countryForm.country.$error.required || countryForm.country.$valid"
																			class="help-block"> Enter the Country </span> <span
																			ng-show="countryForm.country.$error.minlength"
																			class="help-block"> Country have minimum 2 characters</span>
																		<span ng-show="countryForm.country.$error.maxlength"
																			class="help-block"> Country have maximum 128
																			characters</span>
																	</div>
																</div>
															</div>
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countryForm.seoUrl.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="seoUrl"
																			...
																			ng-show="countryForm.seoUrl.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countryForm.seoKeywords.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-3">SEO Key Words </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control"
																			name="seoKeywords" ng-model="saveItem.seoKeywords"
																			ng-maxlength="256" /> <span
																			ng-show="countryForm.seoKeywords.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countryForm.seoTags.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="seoTags"
																			...
																			ng-show="countryForm.seoTags.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countryForm.seoDesc.$valid ? 'has-success' : 'has-error'">
															...
															<div class="row margin-bottom15">
																<div class="form-group">
																	...
																	<div class="col-md-4">
																		<button type="button" ng-click="saveCountry()"
																			ng-disabled="!(!countryForm.$error.required && !countryForm.$error.maxlength && !countryForm.$error.minlength)"
...
<script
	src="<?= asset('app/controllers/admin/country.js') ?>"></script>
</body>
