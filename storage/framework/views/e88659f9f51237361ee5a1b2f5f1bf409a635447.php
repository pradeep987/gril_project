...
<!-- BEGIN CONTAINER -->
<div
	class="page-container" ng-controller="businessCategroyCtrl">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="m-heading-1 border-green m-bordered">
						<h3>Retail Business Categroy</h3>
						<p>Business Categroy master Page</p>
					</div>
					<div class="portlet light bordered" id="form_wizard_1">
						<div class="portlet-body form">
							<form class="businessCategroyForm" name="businessCategroyForm"
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<p>
																Are you sure want to delete this Business Categroy <span
																	id="businessCategroyName"></span>?
															</p>
														...
														<div class="modal-body">
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessCategroyForm.businessCategroy.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-3">Business Categroy
																		<span class="required"> * </span> </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control"
																			name="businessCategroy"
																			ng-model="saveItem.businessCategroy" ng-minlength="2"
																			ng-maxlength="128" required /> <span
																			ng-show="businessCategroyForm.businessCategroy.$error.required || businessCategroyForm.businessCategroy.$valid"
																			class="help-block"> Enter the Business Categroy </span>
																		<span
																			ng-show="businessCategroyForm.businessCategroy.$error.minlength"
																			class="help-block"> Business Categroy have minimum 2
																			characters</span> <span
																			ng-show="businessCategroyForm.businessCategroy.$error.maxlength"
																			class="help-block"> Business Categroy have maximum
																			128 characters</span>
																	</div>
																</div>
															</div>
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessCategroyForm.seoTitle.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-3">SEO Title </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control"
																			name="seoTitle" ng-model="saveItem.seoTitle"
																			ng-maxlength="256" /> <span
																			ng-show="businessCategroyForm.seoTitle.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessCategroyForm.seoUrl.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="seoUrl"
																			...
																			ng-show="businessCategroyForm.seoUrl.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessCategroyForm.seoKeywords.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-3">SEO Key Words </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control"
																			name="seoKeywords" ng-model="saveItem.seoKeywords"
																			ng-maxlength="256" /> <span
																			ng-show="businessCategroyForm.seoKeywords.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessCategroyForm.seoTags.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="seoTags"
																			...
																			ng-show="businessCategroyForm.seoTags.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="businessCategroyForm.seoDesc.$valid ? 'has-success' : 'has-error'">
															...
															<div class="row margin-bottom15">
																<div class="form-group">
																	...
																	<div class="col-md-4">
																		<button type="button"
																			ng-click="saveBusinessCategroy()"
																			ng-disabled="!(!businessCategroyForm.$error.required && !businessCategroyForm.$error.maxlength && !businessCategroyForm.$error.minlength)"
...
<script
	src="<?= asset('app/controllers/admin/businessCategroy.js') ?>"></script>
</body>
