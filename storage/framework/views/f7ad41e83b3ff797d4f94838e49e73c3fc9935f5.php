...
<div class="page-container"
	ng-controller="rentalProfileCntrl">
		...
		<div class="page-content" style="min-height: 476px;">
			...
			<div ui-view="" class="fade-in-up ng-scope">
				...
				<ul class="page-breadcrumb breadcrumb ng-scope">
					...
					<li><a ui-sref="datatablesmanaged">Rental Business</a> <i
						class="fa fa-circle"></i>
					</li>
					<li class="active">Rental Profile</li>
				</ul>
				<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-6 col-sm-12">
							...
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption">
										<i class="fa fa-gift"></i>My Rental Business
									</div>
									<div class="tools">
									...
									<div class="form-body">
										...
										<form class="form-horizontal" name="userClassform1" action="#"
											...
											<input type="hidden" name="id"
												ng-init="rentalBuss[0].id = '<?php echo e(Crypt::encrypt($data[0]->id)); ?>'" />
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussReg"
													ng-init="rentalBuss[0].title = '<?php echo e(!empty($data[0]) ? $data[0]->title : ''); ?>'"
													ng-bind="' : '+rentalBuss[0].title"></div>
												<div class="col-md-8" ng-show="myBussReg">
													<input type="text" class="form-control" name="title"
														ng-model="rentalBuss[0].title" ng-minlength="2"
											...
											<div class="form-group"
												...
												<label class="col-md-4">Classification<span class="required">
														* </span> </label>
												<div class="col-md-8" ng-show="!myBussReg"
													ng-init="rentalBuss[0].clasification = '<?php echo e(!empty($data[0]) ? $data[0]->clasification : ''); ?>'"
													ng-bind="' : '+rentalBuss[0].clasification"></div>
												<div class="col-md-8" ng-show="myBussReg">
													<input type="text" class="form-control"
														name="classifcation"
														ng-model="rentalBuss[0].clasification" ng-minlength="6"
														ng-maxlength="256" required /> <span
											...
											<div class="form-group"
												...
												<label class="col-md-4 left">Description <span
													class="required"> * </span> </label>
												<div class="col-md-8" ng-show="!myBussReg"
													ng-init="rentalBuss[0].description = '<?php echo e(!empty($data[0]) ? $data[0]->description : ''); ?>'"
													ng-bind="' : '+rentalBuss[0].description"></div>
												<div class="col-md-8" ng-show="myBussReg">
													<textarea type="text" class="form-control"
														name="description" ng-model="rentalBuss[0].description"
											...
											<div class="form-group" ng-show="myBussReg">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<button type="button" ng-click="saveMyRentalBussReg()"
									...
									<div class="form-body">
										<form class="form-horizontal" name="userClassform2" action="#"
											...
											<meta name="myBussProfile-csrf-token"
												content="<?php echo e(csrf_token()); ?>">
											<input type="hidden" name="id"
												ng-init="rentalContactDtl[0].id = '<?php echo e(Crypt::encrypt($data[0]->id)); ?>'" />
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].mobile = '<?php echo e(!empty($data[0]) ? $data[0]->mobile : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].mobile"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<input type="text" class="form-control" name="mobile"
														ng-model="rentalContactDtl[0].mobile"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].landline = '<?php echo e(!empty($data[0]) ? $data[0]->landline : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].landline"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<input type="text" class="form-control" name="landline"
														ng-model="rentalContactDtl[0].landline"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].email = '<?php echo e(!empty($data[0]) ? $data[0]->email : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].email"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<input type="text" class="form-control" name="email"
														ng-model="rentalContactDtl[0].email" ng-maxlength="128"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].website = '<?php echo e(!empty($data[0]) ? $data[0]->website : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].website"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<input type="text" class="form-control" name="website"
														ng-model="rentalContactDtl[0].website" ng-minlength="2"
											...
											<div class="form-group"
												...
												<label class="col-md-4">Business Name<span class="required">
														* </span> </label>
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].bussName = '<?php echo e(!empty($data[0]) ? $data[0]->name : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].bussName"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<input type="text" class="form-control" name="bussName"
														ng-model="rentalContactDtl[0].bussName" ng-minlength="2"
														ng-maxlength="256" required /> <span
											...
											<div class="form-group"
												...
												<label class="col-md-4 left">Number/Name<span
													class="required"> * </span> </label>
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].numberName = '<?php echo e(!empty($data[0]) ? $data[0]->number_or_name : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].numberName"
													ng-blur="showGoogleMap()"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<textarea type="text" class="form-control"
														name="numberName"
														ng-model="rentalContactDtl[0].numberName"
											...
											<div class="form-group"
												...
												<label class="col-md-4 left">Address 1<span class="required">
														* </span> </label>
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].address_1 = '<?php echo e(!empty($data[0]) ? $data[0]->address_1 : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].address_1"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<textarea type="text" class="form-control" name="address_1"
														ng-model="rentalContactDtl[0].address_1"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].address_2 = '<?php echo e(!empty($data[0]) ? $data[0]->address_2 : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].address_2"
													ng-blur="showGoogleMap()"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<textarea type="text" class="form-control" name="address_2"
														ng-model="rentalContactDtl[0].address_2"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].postal_code = '<?php echo e(!empty($data[0]) ? $data[0]->postal_code : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].postal_code"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<input type="text" class="form-control" name="postal_code"
														ng-model="rentalContactDtl[0].postal_code"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].city = '<?php echo e(!empty($data[0]) ? $data[0]->city : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].city"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<input type="text" class="form-control" name="city"
														ng-model="rentalContactDtl[0].city" ng-minlength="2"
											...
											<div class="form-group"
												...
												<div class="col-md-8" ng-show="!myBussProfile"
													ng-init="rentalContactDtl[0].county = '<?php echo e(!empty($data[0]) ? $data[0]->county : ''); ?>'"
													ng-bind="' : '+rentalContactDtl[0].county"></div>
												<div class="col-md-8" ng-show="myBussProfile">
													<input type="text" class="form-control" name="county"
														ng-model="rentalContactDtl[0].county" ng-minlength="2"
														ng-maxlength="64" required ng-blur="showGoogleMap()" /> <span
											...
											<div class="form-group" ng-show="myBussProfile">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<button type="button" ng-click="saveMyRentalBussProf()"
	...
	<script
		src="<?= asset('app/controllers/dashboard/rentalController.js') ?>"></script>
