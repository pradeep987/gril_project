			...
			<div class="row">
				<div class="col-md-12">
					<div class="m-heading-1 border-green m-bordered">
						<h3>County</h3>
						<p>State master Page</p>
					</div>
					<div class="portlet light bordered" id="form_wizard_1">
						<div class="portlet-body form">
							<form class="countyForm" name="countyForm" id="submit_form"
								method="POST">
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<p>
																Are you sure want to delete this state <span
																	id="stateName"></span>?
															</p>
														...
														<div class="modal-body">
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countyForm.countryId.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<select id="county" class="form-control"
																			...
																			ng-show="countyForm.countryId.$error.required || countyForm.countryId.$valid"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countyForm.county.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-3">County <span
																		class="required"> * </span> </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="county"
																			ng-model="saveItem.county" ng-minlength="2"
																			ng-maxlength="50" required /> <span
																			ng-show="countyForm.county.$error.required || countyForm.county.$valid"
																			class="help-block"> Enter the County </span> <span
																			ng-show="countyForm.county.$error.minlength"
																			class="help-block"> County have minimum 2 characters</span>
																		<span ng-show="countyForm.county.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countyForm.seoUrl.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="seoUrl"
																			...
																			ng-show="countyForm.seoUrl.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countyForm.seoKeywords.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-3">SEO Key Words </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control"
																			name="seoKeywords" ng-model="saveItem.seoKeywords"
																			ng-maxlength="256" /> <span
																			ng-show="countyForm.seoKeywords.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countyForm.seoTags.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="seoTags"
																			...
																			ng-show="countyForm.seoTags.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="countyForm.seoDesc.$valid ? 'has-success' : 'has-error'">
															...
															<div class="row margin-bottom15">
																<div class="form-group">
																	...
																	<div class="col-md-4">
																		<button type="button" ng-click="saveCounty()"
																			ng-disabled="!(!countyForm.$error.required && !countyForm.$error.maxlength && !countyForm.$error.minlength)"
