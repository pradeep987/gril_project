...
<!-- BEGIN CONTAINER -->
<div
	class="page-container" ng-controller="productTypeCtrl">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="m-heading-1 border-green m-bordered">
						<h3>Retail Product Type</h3>
						<p>Product Type master Page</p>
					</div>
					<div class="portlet light bordered" id="form_wizard_1">
						<div class="portlet-body form">
							<form class="productTypeForm" name="productTypeForm"
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<p>
																Are you sure want to delete this Product Type <span
																	id="productTypeName"></span>?
															</p>
														...
														<div class="modal-body">
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="productTypeForm.bcId.$valid ? 'has-success' : 'has-error'">
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="productTypeForm.btId.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<select id="county" class="form-control" name="btId"
																			...
																			ng-options="obj.id as obj.name for obj in bussinessTypeList">
																			<option value="">Please Select</option>
																		</select> <span
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="productTypeForm.productType.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-4">Product Type <span
																		class="required"> * </span> </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control"
																			name="productType" ng-model="saveItem.productType"
																			ng-minlength="2" ng-maxlength="128" required /> <span
																			ng-show="productTypeForm.productType.$error.required || productTypeForm.productType.$valid"
																			class="help-block"> Enter the Product Type </span> <span
																			ng-show="productTypeForm.productType.$error.minlength"
																			class="help-block"> Product Type have minimum 2
																			characters</span> <span
																			ng-show="productTypeForm.productType.$error.maxlength"
																			class="help-block"> Product Type have maximum 128
																			characters</span>
																	</div>
																</div>
															</div>
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="productTypeForm.seoUrl.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="seoUrl"
																			...
																			ng-show="productTypeForm.seoUrl.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="productTypeForm.seoKeywords.$valid ? 'has-success' : 'has-error'">
																	<label class="control-label col-md-4">SEO Key Words </label>
																	<div class="col-md-8">
																		<input type="text" class="form-control"
																			name="seoKeywords" ng-model="saveItem.seoKeywords"
																			ng-maxlength="256" /> <span
																			ng-show="productTypeForm.seoKeywords.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="productTypeForm.seoTags.$valid ? 'has-success' : 'has-error'">
																	...
																	<div class="col-md-8">
																		<input type="text" class="form-control" name="seoTags"
																			...
																			ng-show="productTypeForm.seoTags.$error.maxlength"
															...
															<div class="row margin-bottom15">
																<div class="form-group"
																	ng-class="productTypeForm.seoDesc.$valid ? 'has-success' : 'has-error'">
															...
															<div class="row margin-bottom15">
																<div class="form-group">
																	...
																	<div class="col-md-4">
																		<button type="button" ng-click="saveProductType()"
																			ng-disabled="!(!productTypeForm.$error.required && !productTypeForm.$error.maxlength && !productTypeForm.$error.minlength)"
...
<script
	src="<?= asset('app/controllers/admin/productType.js') ?>"></script>
</body>
