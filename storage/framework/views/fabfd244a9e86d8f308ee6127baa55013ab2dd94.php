...
<body>
    ...
    <!--------------- Header --------------->
    <?php echo $__env->make("home.Envato.header", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>; 
    
    <!--------------- Primary navigation --------------->
     <?php echo $__env->make("home.Envato.menu", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-4">
                    ...
                    <?php echo $__env->make("home.Envato.sidemenu", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
    ...
    <?php echo $__env->make("home.Envato.footer", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
    <!--------------- Back to Top --------------->
