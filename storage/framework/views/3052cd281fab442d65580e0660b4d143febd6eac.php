...
<!-- BEGIN CORE PLUGINS -->
<script
	src="<?= asset('assets/global/plugins/jquery.min.js') ?>"
...
<script
	src="<?= asset('assets/global/scripts/app.min.js') ?>"
	type="text/javascript"></script>
...
<script
	src="<?= asset('app/lib/angular/ui-grid.min.js') ?>"></script>
<script
	src="<?= asset('app/lib/angular/angular-touch.js') ?>"></script>
<script
	src="<?= asset('app/controllers/admin/app.js') ?>"></script>
<script
